package com.xlibrarykr.eduorigin.adapters;
...
import com.xlibrarykr.eduorigin.PdfViewerActivity;
...
public class BookLibraryAdapter extends RecyclerView.Adapter<BookLibraryAdapter.viewHolder> implements Filterable {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
             ...
             Glide.with(holder.singleRowName.getContext()).load("https://timxn.com/ecom/EduOriginAPI/Registration/images/"+data.get(position).getImage()).into(holder.singleRowImage);
